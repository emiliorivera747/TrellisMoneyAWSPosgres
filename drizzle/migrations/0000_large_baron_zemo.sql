...
ALTER TABLE "Account" ADD CONSTRAINT "Account_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."HouseholdMember"("member_id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "Subscription_user_id_key" ON "Subscription" USING btree ("user_id" text_ops);