...
const SideNavigationBar: React.FC = () => {
  ...
  return (
    <aside className=" border-tertiary-200 flex flex-col sm:flex-row justify-start w-full sm:justify-center sm:w-24 2xl:w-48 min-w-24 sticky text-white sm:border-r border-tertiary-300 border-box sm:h-screen m-w-screen overflow-x-scroll">
