...
const PrimarySubmitButton = React.forwardRef<HTMLButtonElement, SubmitButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>>(({
  text = "Submit",
  className,
}, ref) => {
  ...
  return (
    <button type="submit" className={cn(defaultClass, className)} disabled={pending} ref={ref}>
      {pending ? (
        <DotLoader
          bgColor="bg-blue-200"
          dotHeight="h-2"
