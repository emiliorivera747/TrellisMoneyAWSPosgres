...
const LineGraphFilterButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`px-1 gap-2 hover:bg-tertiary-200 transition duration-300 py-[0.7rem]  rounded-[12px] text-xs hover:text-tertiary-1000 hover:border-tertiary-200   flex flex-row justify-center items-center text-center border ${
        isSelected
