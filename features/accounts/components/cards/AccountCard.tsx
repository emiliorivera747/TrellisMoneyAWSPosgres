...
const AccountCard = ({ account, member }: AccountCardProps) => {
  return (
    <div
      ...
      className="bg-white/30 backdrop-blur-md  p-4 px-4 rounded-[12px] grid grid-cols-3 mb-4 border border-tertiary-200 hover:shadow-lg transition duration-500 ease-in-out w-full items-center"
    >
